...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-fire": "linear-gradient(135deg, hsl(var(--primary)), hsl(var(--accent)), hsl(var(--fire)))",
        "gradient-warm": "linear-gradient(180deg, hsl(var(--primary)) 0%, hsl(var(--accent)) 100%)",
        "gradient-dark": "linear-gradient(180deg, hsl(0 0% 10%) 0%, hsl(0 0% 5%) 100%)",
      },
      boxShadow: {
        soft: "0 4px 20px -4px hsl(0 0% 0% / 0.1)",
        card: "0 8px 30px -8px hsl(0 0% 0% / 0.15)",
        "glow-primary": "0 0 30px hsl(var(--primary) / 0.4)",
        "glow-accent": "0 0 30px hsl(var(--accent) / 0.4)",
        "glow-fire": "0 0 30px hsl(var(--fire) / 0.4)",
      },
    },
  },
